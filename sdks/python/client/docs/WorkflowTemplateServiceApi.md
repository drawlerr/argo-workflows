...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    body = argo_workflows.WorkflowTemplateCreateRequest() # WorkflowTemplateCreateRequest | 
...
> WorkflowTemplate get_workflow_template(namespace, name, get_options_resource_version=get_options_resource_version)
...
> WorkflowTemplate lint_workflow_template(namespace, body)
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    api_instance = argo_workflows.WorkflowTemplateServiceApi(api_client)
    namespace = 'namespace_example' # str | 
    body = argo_workflows.WorkflowTemplateLintRequest() # WorkflowTemplateLintRequest | 
...
> WorkflowTemplate update_workflow_template(namespace, name, body)
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    body = argo_workflows.WorkflowTemplateUpdateRequest() # WorkflowTemplateUpdateRequest | 
