...
# **create_event_source**
> EventSource create_event_source(namespace, body)
...
# **get_event_source**
> EventSource get_event_source(namespace, name)
...
[**EventSourceList**](EventSourceList.md)
...
# **update_event_source**
> EventSource update_event_source(namespace, name, body)
