...
user_container_instance = UserContainer.from_json(json)
# print the JSON string representation of the object
print UserContainer.to_json()

# convert the object into a dict
user_container_dict = user_container_instance.to_dict()
# create an instance of UserContainer from a dict
user_container_form_dict = user_container.from_dict(user_container_dict)
```
