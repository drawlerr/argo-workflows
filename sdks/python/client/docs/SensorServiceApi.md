...
# **create_sensor**
> Sensor create_sensor(namespace, body)
...
# **get_sensor**
> Sensor get_sensor(namespace, name, get_options_resource_version=get_options_resource_version)
...
# **update_sensor**
> Sensor update_sensor(namespace, name, body)
