...
> ClusterWorkflowTemplate create_cluster_workflow_template(body)
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    body = argo_workflows.ClusterWorkflowTemplateCreateRequest() # ClusterWorkflowTemplateCreateRequest | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**ClusterWorkflowTemplateCreateRequest**](ClusterWorkflowTemplateCreateRequest.md)|  | 
...
> ClusterWorkflowTemplate get_cluster_workflow_template(name, get_options_resource_version=get_options_resource_version)
...
> ClusterWorkflowTemplate lint_cluster_workflow_template(body)
...
with argo_workflows.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = argo_workflows.ClusterWorkflowTemplateServiceApi(api_client)
    body = argo_workflows.ClusterWorkflowTemplateLintRequest() # ClusterWorkflowTemplateLintRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**ClusterWorkflowTemplateLintRequest**](ClusterWorkflowTemplateLintRequest.md)|  | 
...
> ClusterWorkflowTemplate update_cluster_workflow_template(name, body)
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    body = argo_workflows.ClusterWorkflowTemplateUpdateRequest() # ClusterWorkflowTemplateUpdateRequest | 
 ...
 **body** | [**ClusterWorkflowTemplateUpdateRequest**](ClusterWorkflowTemplateUpdateRequest.md)|  | 
