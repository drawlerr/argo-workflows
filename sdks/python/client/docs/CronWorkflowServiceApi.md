...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    body = argo_workflows.CreateCronWorkflowRequest() # CreateCronWorkflowRequest | 
...
# **get_cron_workflow**
> CronWorkflow get_cron_workflow(namespace, name, get_options_resource_version=get_options_resource_version)
...
# **lint_cron_workflow**
> CronWorkflow lint_cron_workflow(namespace, body)
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    api_instance = argo_workflows.CronWorkflowServiceApi(api_client)
    namespace = 'namespace_example' # str | 
    body = argo_workflows.LintCronWorkflowRequest() # LintCronWorkflowRequest | 
...
> CronWorkflow resume_cron_workflow(namespace, name, body)
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    namespace = 'namespace_example' # str | 
    name = 'name_example' # str | 
    body = argo_workflows.CronWorkflowResumeRequest() # CronWorkflowResumeRequest | 
...
> CronWorkflow suspend_cron_workflow(namespace, name, body)
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    namespace = 'namespace_example' # str | 
    name = 'name_example' # str | 
    body = argo_workflows.CronWorkflowSuspendRequest() # CronWorkflowSuspendRequest | 
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    body = argo_workflows.UpdateCronWorkflowRequest() # UpdateCronWorkflowRequest | 
