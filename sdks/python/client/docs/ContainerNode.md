...
json = "{}"
# create an instance of ContainerNode from a JSON string
container_node_instance = ContainerNode.from_json(json)
# print the JSON string representation of the object
print ContainerNode.to_json()

# convert the object into a dict
container_node_dict = container_node_instance.to_dict()
# create an instance of ContainerNode from a dict
container_node_form_dict = container_node.from_dict(container_node_dict)
```
