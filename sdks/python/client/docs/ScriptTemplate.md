...
json = "{}"
# create an instance of ScriptTemplate from a JSON string
script_template_instance = ScriptTemplate.from_json(json)
# print the JSON string representation of the object
print ScriptTemplate.to_json()

# convert the object into a dict
script_template_dict = script_template_instance.to_dict()
# create an instance of ScriptTemplate from a dict
script_template_form_dict = script_template.from_dict(script_template_dict)
```
