...
class S3ArtifactRepository(BaseModel):
    ...
    create_bucket_if_not_present: Optional[CreateS3BucketOptions] = Field(default=None, alias="createBucketIfNotPresent")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "createBucketIfNotPresent": CreateS3BucketOptions.from_dict(obj.get("createBucketIfNotPresent")) if obj.get("createBucketIfNotPresent") is not None else None,
            "encryptionOptions": S3EncryptionOptions.from_dict(obj.get("encryptionOptions")) if obj.get("encryptionOptions") is not None else None,
