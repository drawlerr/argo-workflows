...
class ValueFrom(BaseModel):
    ...
    event: Optional[StrictStr] = Field(default=None, description="Selector (https://github.com/antonmedv/expr) that is evaluated against the event to get the value of the parameter. E.g. `payload.message`")
