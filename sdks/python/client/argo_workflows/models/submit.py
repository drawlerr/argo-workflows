...
class Submit(BaseModel):
    ...
    workflow_template_ref: WorkflowTemplateRef = Field(alias="workflowTemplateRef")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": ObjectMeta.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None,
