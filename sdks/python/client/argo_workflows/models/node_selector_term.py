...
class NodeSelectorTerm(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "matchExpressions": [NodeSelectorRequirement.from_dict(_item) for _item in obj.get("matchExpressions")] if obj.get("matchExpressions") is not None else None,
            "matchFields": [NodeSelectorRequirement.from_dict(_item) for _item in obj.get("matchFields")] if obj.get("matchFields") is not None else None
        })
        return _obj
