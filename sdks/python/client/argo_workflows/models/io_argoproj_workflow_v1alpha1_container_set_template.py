...
class IoArgoprojWorkflowV1alpha1ContainerSetTemplate(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "containers": [IoArgoprojWorkflowV1alpha1ContainerNode.from_dict(_item) for _item in obj.get("containers")] if obj.get("containers") is not None else None,
            "retryStrategy": IoArgoprojWorkflowV1alpha1ContainerSetRetryStrategy.from_dict(obj.get("retryStrategy")) if obj.get("retryStrategy") is not None else None,
