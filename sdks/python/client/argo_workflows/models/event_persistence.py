...
class EventPersistence(BaseModel):
    ...
    EventPersistence
    """ # noqa: E501
    catchup: Optional[CatchupConfiguration] = None
    config_map: Optional[ConfigMapPersistence] = Field(default=None, alias="configMap")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "catchup": CatchupConfiguration.from_dict(obj.get("catchup")) if obj.get("catchup") is not None else None,
            "configMap": ConfigMapPersistence.from_dict(obj.get("configMap")) if obj.get("configMap") is not None else None
        })
        return _obj
