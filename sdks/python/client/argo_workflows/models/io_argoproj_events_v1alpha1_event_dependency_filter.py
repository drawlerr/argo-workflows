...
class IoArgoprojEventsV1alpha1EventDependencyFilter(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "context": IoArgoprojEventsV1alpha1EventContext.from_dict(obj.get("context")) if obj.get("context") is not None else None,
            "data": [IoArgoprojEventsV1alpha1DataFilter.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "dataLogicalOperator": obj.get("dataLogicalOperator"),
            "exprLogicalOperator": obj.get("exprLogicalOperator"),
            "exprs": [IoArgoprojEventsV1alpha1ExprFilter.from_dict(_item) for _item in obj.get("exprs")] if obj.get("exprs") is not None else None,
            "script": obj.get("script"),
            "time": IoArgoprojEventsV1alpha1TimeFilter.from_dict(obj.get("time")) if obj.get("time") is not None else None
        })
        return _obj
