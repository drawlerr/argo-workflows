...
class IoArgoprojWorkflowV1alpha1WorkflowEventBindingSpec(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "event": IoArgoprojWorkflowV1alpha1Event.from_dict(obj.get("event")) if obj.get("event") is not None else None,
            "submit": IoArgoprojWorkflowV1alpha1Submit.from_dict(obj.get("submit")) if obj.get("submit") is not None else None
        })
        return _obj
