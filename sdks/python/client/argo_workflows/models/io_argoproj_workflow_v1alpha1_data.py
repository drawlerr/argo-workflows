...
class IoArgoprojWorkflowV1alpha1Data(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "source": IoArgoprojWorkflowV1alpha1DataSource.from_dict(obj.get("source")) if obj.get("source") is not None else None,
            "transformation": [IoArgoprojWorkflowV1alpha1TransformationStep.from_dict(_item) for _item in obj.get("transformation")] if obj.get("transformation") is not None else None
        })
        return _obj
