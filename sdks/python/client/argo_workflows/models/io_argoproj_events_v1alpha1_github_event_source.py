...
class IoArgoprojEventsV1alpha1GithubEventSource(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "githubApp": IoArgoprojEventsV1alpha1GithubAppCreds.from_dict(obj.get("githubApp")) if obj.get("githubApp") is not None else None,
            ...
            "owner": obj.get("owner"),
            "repositories": [IoArgoprojEventsV1alpha1OwnedRepositories.from_dict(_item) for _item in obj.get("repositories")] if obj.get("repositories") is not None else None,
