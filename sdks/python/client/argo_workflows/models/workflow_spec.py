...
class WorkflowSpec(BaseModel):
    ...
    """ # noqa: E501
    active_deadline_seconds: Optional[StrictInt] = Field(default=None, description="Optional duration in seconds relative to the workflow start time which the workflow is allowed to run before the controller terminates the  A value of zero is used to terminate a Running workflow", alias="activeDeadlineSeconds")
    ...
    artifact_gc: Optional[WorkflowLevelArtifactGC] = Field(default=None, alias="artifactGC")
    artifact_repository_ref: Optional[ArtifactRepositoryRef] = Field(default=None, alias="artifactRepositoryRef")
    ...
    entrypoint: Optional[StrictStr] = Field(default=None, description="Entrypoint is a template reference to the starting point of the ")
    executor: Optional[ExecutorConfig] = None
    hooks: Optional[Dict[str, LifecycleHook]] = Field(default=None, description="Hooks holds the lifecycle hook which is invoked at lifecycle of step, irrespective of the success, failure, or error status of the primary step")
    ...
    on_exit: Optional[StrictStr] = Field(default=None, description="OnExit is a template reference which is invoked at the end of the workflow, irrespective of the success, failure, or error of the primary ", alias="onExit")
    ...
    pod_disruption_budget: Optional[PodDisruptionBudgetSpec] = Field(default=None, alias="podDisruptionBudget")
    pod_gc: Optional[PodGC] = Field(default=None, alias="podGC")
    ...
    retry_strategy: Optional[RetryStrategy] = Field(default=None, alias="retryStrategy")
    ...
    template_defaults: Optional[Template] = Field(default=None, alias="templateDefaults")
    templates: Optional[List[Template]] = Field(default=None, description="Templates is a list of workflow templates used in a workflow")
    tolerations: Optional[List[Toleration]] = Field(default=None, description="Tolerations to apply to workflow pods.")
    ttl_strategy: Optional[TTLStrategy] = Field(default=None, alias="ttlStrategy")
    volume_claim_gc: Optional[VolumeClaimGC] = Field(default=None, alias="volumeClaimGC")
    ...
    volumes: Optional[List[Volume]] = Field(default=None, description="Volumes is a list of volumes that can be mounted by containers in a ")
    workflow_metadata: Optional[WorkflowMetadata] = Field(default=None, alias="workflowMetadata")
    workflow_template_ref: Optional[WorkflowTemplateRef] = Field(default=None, alias="workflowTemplateRef")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "affinity": Affinity.from_dict(obj.get("affinity")) if obj.get("affinity") is not None else None,
            ...
            "artifactGC": WorkflowLevelArtifactGC.from_dict(obj.get("artifactGC")) if obj.get("artifactGC") is not None else None,
            "artifactRepositoryRef": ArtifactRepositoryRef.from_dict(obj.get("artifactRepositoryRef")) if obj.get("artifactRepositoryRef") is not None else None,
            "automountServiceAccountToken": obj.get("automountServiceAccountToken"),
            "dnsConfig": PodDNSConfig.from_dict(obj.get("dnsConfig")) if obj.get("dnsConfig") is not None else None,
            "dnsPolicy": obj.get("dnsPolicy"),
            "entrypoint": obj.get("entrypoint"),
            "executor": ExecutorConfig.from_dict(obj.get("executor")) if obj.get("executor") is not None else None,
            "hooks": dict(
            ...
            "hostAliases": [HostAlias.from_dict(_item) for _item in obj.get("hostAliases")] if obj.get("hostAliases") is not None else None,
            "hostNetwork": obj.get("hostNetwork"),
            "imagePullSecrets": [LocalObjectReference.from_dict(_item) for _item in obj.get("imagePullSecrets")] if obj.get("imagePullSecrets") is not None else None,
            "metrics": Metrics.from_dict(obj.get("metrics")) if obj.get("metrics") is not None else None,
            "nodeSelector": obj.get("nodeSelector"),
            "onExit": obj.get("onExit"),
            "parallelism": obj.get("parallelism"),
            "podDisruptionBudget": PodDisruptionBudgetSpec.from_dict(obj.get("podDisruptionBudget")) if obj.get("podDisruptionBudget") is not None else None,
            "podGC": PodGC.from_dict(obj.get("podGC")) if obj.get("podGC") is not None else None,
            ...
            "retryStrategy": RetryStrategy.from_dict(obj.get("retryStrategy")) if obj.get("retryStrategy") is not None else None,
            "schedulerName": obj.get("schedulerName"),
            "securityContext": PodSecurityContext.from_dict(obj.get("securityContext")) if obj.get("securityContext") is not None else None,
            "serviceAccountName": obj.get("serviceAccountName"),
            "shutdown": obj.get("shutdown"),
            "suspend": obj.get("suspend"),
            "synchronization": Synchronization.from_dict(obj.get("synchronization")) if obj.get("synchronization") is not None else None,
            "templateDefaults": Template.from_dict(obj.get("templateDefaults")) if obj.get("templateDefaults") is not None else None,
            "templates": [Template.from_dict(_item) for _item in obj.get("templates")] if obj.get("templates") is not None else None,
            "tolerations": [Toleration.from_dict(_item) for _item in obj.get("tolerations")] if obj.get("tolerations") is not None else None,
            "ttlStrategy": TTLStrategy.from_dict(obj.get("ttlStrategy")) if obj.get("ttlStrategy") is not None else None,
            "volumeClaimGC": VolumeClaimGC.from_dict(obj.get("volumeClaimGC")) if obj.get("volumeClaimGC") is not None else None,
            "volumeClaimTemplates": [PersistentVolumeClaim.from_dict(_item) for _item in obj.get("volumeClaimTemplates")] if obj.get("volumeClaimTemplates") is not None else None,
            "volumes": [Volume.from_dict(_item) for _item in obj.get("volumes")] if obj.get("volumes") is not None else None,
            "workflowMetadata": WorkflowMetadata.from_dict(obj.get("workflowMetadata")) if obj.get("workflowMetadata") is not None else None,
            "workflowTemplateRef": WorkflowTemplateRef.from_dict(obj.get("workflowTemplateRef")) if obj.get("workflowTemplateRef") is not None else None
        })
        return _obj
