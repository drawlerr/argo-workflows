...
class CronWorkflowSpec(BaseModel):
    ...
    stop_strategy: Optional[StopStrategy] = Field(default=None, alias="stopStrategy")
    ...
    workflow_spec: WorkflowSpec = Field(alias="workflowSpec")
    __properties: ClassVar[List[str]] = ["concurrencyPolicy", "failedJobsHistoryLimit", "schedule", "startingDeadlineSeconds", "stopStrategy", "successfulJobsHistoryLimit", "suspend", "timezone", "workflowMetadata", "workflowSpec"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "stopStrategy": StopStrategy.from_dict(obj.get("stopStrategy")) if obj.get("stopStrategy") is not None else None,
            "successfulJobsHistoryLimit": obj.get("successfulJobsHistoryLimit"),
            "suspend": obj.get("suspend"),
            "timezone": obj.get("timezone"),
            "workflowMetadata": ObjectMeta.from_dict(obj.get("workflowMetadata")) if obj.get("workflowMetadata") is not None else None,
            "workflowSpec": WorkflowSpec.from_dict(obj.get("workflowSpec")) if obj.get("workflowSpec") is not None else None
        })
        return _obj
