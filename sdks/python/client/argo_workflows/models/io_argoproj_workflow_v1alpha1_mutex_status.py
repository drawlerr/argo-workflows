...
class IoArgoprojWorkflowV1alpha1MutexStatus(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "holding": [IoArgoprojWorkflowV1alpha1MutexHolding.from_dict(_item) for _item in obj.get("holding")] if obj.get("holding") is not None else None,
            "waiting": [IoArgoprojWorkflowV1alpha1MutexHolding.from_dict(_item) for _item in obj.get("waiting")] if obj.get("waiting") is not None else None
        })
        return _obj
