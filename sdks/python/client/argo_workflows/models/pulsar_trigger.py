...
class PulsarTrigger(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["authTokenSecret", "connectionBackoff", "parameters", "payload", "tls", "tlsAllowInsecureConnection", "tlsTrustCertsSecret", "tlsValidateHostname", "topic", "url"]
