...
class PersistentVolumeClaimSpec(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "dataSource": TypedLocalObjectReference.from_dict(obj.get("dataSource")) if obj.get("dataSource") is not None else None,
            "dataSourceRef": TypedLocalObjectReference.from_dict(obj.get("dataSourceRef")) if obj.get("dataSourceRef") is not None else None,
            "resources": ResourceRequirements.from_dict(obj.get("resources")) if obj.get("resources") is not None else None,
            "selector": LabelSelector.from_dict(obj.get("selector")) if obj.get("selector") is not None else None,
