...
class IoArgoprojEventsV1alpha1GitArtifact(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "creds": IoArgoprojEventsV1alpha1GitCreds.from_dict(obj.get("creds")) if obj.get("creds") is not None else None,
            "filePath": obj.get("filePath"),
            "insecureIgnoreHostKey": obj.get("insecureIgnoreHostKey"),
            "ref": obj.get("ref"),
            "remote": IoArgoprojEventsV1alpha1GitRemoteConfig.from_dict(obj.get("remote")) if obj.get("remote") is not None else None,
            "sshKeySecret": SecretKeySelector.from_dict(obj.get("sshKeySecret")) if obj.get("sshKeySecret") is not None else None,
            "tag": obj.get("tag"),
            "url": obj.get("url")
        })
        return _obj
