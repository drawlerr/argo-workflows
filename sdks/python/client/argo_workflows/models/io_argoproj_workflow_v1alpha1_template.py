...
class IoArgoprojWorkflowV1alpha1Template(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "archiveLocation": IoArgoprojWorkflowV1alpha1ArtifactLocation.from_dict(obj.get("archiveLocation")) if obj.get("archiveLocation") is not None else None,
            ...
            "containerSet": IoArgoprojWorkflowV1alpha1ContainerSetTemplate.from_dict(obj.get("containerSet")) if obj.get("containerSet") is not None else None,
            "daemon": obj.get("daemon"),
            "dag": IoArgoprojWorkflowV1alpha1DAGTemplate.from_dict(obj.get("dag")) if obj.get("dag") is not None else None,
            "data": IoArgoprojWorkflowV1alpha1Data.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            ...
            "http": IoArgoprojWorkflowV1alpha1HTTP.from_dict(obj.get("http")) if obj.get("http") is not None else None,
            "initContainers": [IoArgoprojWorkflowV1alpha1UserContainer.from_dict(_item) for _item in obj.get("initContainers")] if obj.get("initContainers") is not None else None,
            "inputs": IoArgoprojWorkflowV1alpha1Inputs.from_dict(obj.get("inputs")) if obj.get("inputs") is not None else None,
            "memoize": IoArgoprojWorkflowV1alpha1Memoize.from_dict(obj.get("memoize")) if obj.get("memoize") is not None else None,
            "metadata": IoArgoprojWorkflowV1alpha1Metadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None,
            ...
            "outputs": IoArgoprojWorkflowV1alpha1Outputs.from_dict(obj.get("outputs")) if obj.get("outputs") is not None else None,
            ...
            "resource": IoArgoprojWorkflowV1alpha1ResourceTemplate.from_dict(obj.get("resource")) if obj.get("resource") is not None else None,
            ...
            "script": IoArgoprojWorkflowV1alpha1ScriptTemplate.from_dict(obj.get("script")) if obj.get("script") is not None else None,
            ...
            "sidecars": [IoArgoprojWorkflowV1alpha1UserContainer.from_dict(_item) for _item in obj.get("sidecars")] if obj.get("sidecars") is not None else None,
            "steps": [IoArgoprojWorkflowV1alpha1ParallelSteps.from_dict(_item) for _item in obj.get("steps")] if obj.get("steps") is not None else None,
            "suspend": IoArgoprojWorkflowV1alpha1SuspendTemplate.from_dict(obj.get("suspend")) if obj.get("suspend") is not None else None,
