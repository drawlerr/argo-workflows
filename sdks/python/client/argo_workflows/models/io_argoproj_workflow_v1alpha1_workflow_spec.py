...
class IoArgoprojWorkflowV1alpha1WorkflowSpec(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "arguments": IoArgoprojWorkflowV1alpha1Arguments.from_dict(obj.get("arguments")) if obj.get("arguments") is not None else None,
            "artifactGC": IoArgoprojWorkflowV1alpha1WorkflowLevelArtifactGC.from_dict(obj.get("artifactGC")) if obj.get("artifactGC") is not None else None,
            "artifactRepositoryRef": IoArgoprojWorkflowV1alpha1ArtifactRepositoryRef.from_dict(obj.get("artifactRepositoryRef")) if obj.get("artifactRepositoryRef") is not None else None,
            ...
            "executor": IoArgoprojWorkflowV1alpha1ExecutorConfig.from_dict(obj.get("executor")) if obj.get("executor") is not None else None,
            "hooks": dict(
            ...
            "metrics": IoArgoprojWorkflowV1alpha1Metrics.from_dict(obj.get("metrics")) if obj.get("metrics") is not None else None,
            "nodeSelector": obj.get("nodeSelector"),
            "onExit": obj.get("onExit"),
            "parallelism": obj.get("parallelism"),
            "podDisruptionBudget": IoK8sApiPolicyV1PodDisruptionBudgetSpec.from_dict(obj.get("podDisruptionBudget")) if obj.get("podDisruptionBudget") is not None else None,
            "podGC": IoArgoprojWorkflowV1alpha1PodGC.from_dict(obj.get("podGC")) if obj.get("podGC") is not None else None,
            "podMetadata": IoArgoprojWorkflowV1alpha1Metadata.from_dict(obj.get("podMetadata")) if obj.get("podMetadata") is not None else None,
            "podPriority": obj.get("podPriority"),
            "podPriorityClassName": obj.get("podPriorityClassName"),
            "podSpecPatch": obj.get("podSpecPatch"),
            "priority": obj.get("priority"),
            "retryStrategy": IoArgoprojWorkflowV1alpha1RetryStrategy.from_dict(obj.get("retryStrategy")) if obj.get("retryStrategy") is not None else None,
            ...
            "synchronization": IoArgoprojWorkflowV1alpha1Synchronization.from_dict(obj.get("synchronization")) if obj.get("synchronization") is not None else None,
            "templateDefaults": IoArgoprojWorkflowV1alpha1Template.from_dict(obj.get("templateDefaults")) if obj.get("templateDefaults") is not None else None,
            "templates": [IoArgoprojWorkflowV1alpha1Template.from_dict(_item) for _item in obj.get("templates")] if obj.get("templates") is not None else None,
            "tolerations": [Toleration.from_dict(_item) for _item in obj.get("tolerations")] if obj.get("tolerations") is not None else None,
            "ttlStrategy": IoArgoprojWorkflowV1alpha1TTLStrategy.from_dict(obj.get("ttlStrategy")) if obj.get("ttlStrategy") is not None else None,
            "volumeClaimGC": IoArgoprojWorkflowV1alpha1VolumeClaimGC.from_dict(obj.get("volumeClaimGC")) if obj.get("volumeClaimGC") is not None else None,
            ...
            "workflowMetadata": IoArgoprojWorkflowV1alpha1WorkflowMetadata.from_dict(obj.get("workflowMetadata")) if obj.get("workflowMetadata") is not None else None,
            "workflowTemplateRef": IoArgoprojWorkflowV1alpha1WorkflowTemplateRef.from_dict(obj.get("workflowTemplateRef")) if obj.get("workflowTemplateRef") is not None else None
        })
        return _obj
