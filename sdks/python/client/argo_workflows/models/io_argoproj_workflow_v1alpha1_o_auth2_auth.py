...
class IoArgoprojWorkflowV1alpha1OAuth2Auth(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "clientIDSecret": SecretKeySelector.from_dict(obj.get("clientIDSecret")) if obj.get("clientIDSecret") is not None else None,
            "clientSecretSecret": SecretKeySelector.from_dict(obj.get("clientSecretSecret")) if obj.get("clientSecretSecret") is not None else None,
            "endpointParams": [IoArgoprojWorkflowV1alpha1OAuth2EndpointParam.from_dict(_item) for _item in obj.get("endpointParams")] if obj.get("endpointParams") is not None else None,
            "scopes": obj.get("scopes"),
            "tokenURLSecret": SecretKeySelector.from_dict(obj.get("tokenURLSecret")) if obj.get("tokenURLSecret") is not None else None
        })
        return _obj
