...
class ResourceFilter(BaseModel):
    ...
    fields: Optional[List[Selector]] = None
    labels: Optional[List[Selector]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "fields": [Selector.from_dict(_item) for _item in obj.get("fields")] if obj.get("fields") is not None else None,
            "labels": [Selector.from_dict(_item) for _item in obj.get("labels")] if obj.get("labels") is not None else None,
