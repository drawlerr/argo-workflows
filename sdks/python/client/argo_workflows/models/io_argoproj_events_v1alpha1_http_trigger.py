...
class IoArgoprojEventsV1alpha1HTTPTrigger(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "basicAuth": IoArgoprojEventsV1alpha1BasicAuth.from_dict(obj.get("basicAuth")) if obj.get("basicAuth") is not None else None,
            ...
            "secureHeaders": [IoArgoprojEventsV1alpha1SecureHeader.from_dict(_item) for _item in obj.get("secureHeaders")] if obj.get("secureHeaders") is not None else None,
