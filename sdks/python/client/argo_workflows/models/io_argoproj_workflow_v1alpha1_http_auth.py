...
class IoArgoprojWorkflowV1alpha1HTTPAuth(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "basicAuth": IoArgoprojWorkflowV1alpha1BasicAuth.from_dict(obj.get("basicAuth")) if obj.get("basicAuth") is not None else None,
            "clientCert": IoArgoprojWorkflowV1alpha1ClientCertAuth.from_dict(obj.get("clientCert")) if obj.get("clientCert") is not None else None,
            "oauth2": IoArgoprojWorkflowV1alpha1OAuth2Auth.from_dict(obj.get("oauth2")) if obj.get("oauth2") is not None else None
        })
        return _obj
