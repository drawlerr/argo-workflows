...
class VolumeProjection(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "configMap": ConfigMapProjection.from_dict(obj.get("configMap")) if obj.get("configMap") is not None else None,
            "downwardAPI": DownwardAPIProjection.from_dict(obj.get("downwardAPI")) if obj.get("downwardAPI") is not None else None,
            "secret": SecretProjection.from_dict(obj.get("secret")) if obj.get("secret") is not None else None,
            "serviceAccountToken": ServiceAccountTokenProjection.from_dict(obj.get("serviceAccountToken")) if obj.get("serviceAccountToken") is not None else None
        })
        return _obj
