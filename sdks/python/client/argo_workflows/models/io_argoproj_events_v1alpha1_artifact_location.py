...
class IoArgoprojEventsV1alpha1ArtifactLocation(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "configmap": ConfigMapKeySelector.from_dict(obj.get("configmap")) if obj.get("configmap") is not None else None,
            "file": IoArgoprojEventsV1alpha1FileArtifact.from_dict(obj.get("file")) if obj.get("file") is not None else None,
            "git": IoArgoprojEventsV1alpha1GitArtifact.from_dict(obj.get("git")) if obj.get("git") is not None else None,
            "inline": obj.get("inline"),
            "resource": IoArgoprojEventsV1alpha1Resource.from_dict(obj.get("resource")) if obj.get("resource") is not None else None,
            "s3": IoArgoprojEventsV1alpha1S3Artifact.from_dict(obj.get("s3")) if obj.get("s3") is not None else None,
            "url": IoArgoprojEventsV1alpha1URLArtifact.from_dict(obj.get("url")) if obj.get("url") is not None else None
        })
        return _obj
