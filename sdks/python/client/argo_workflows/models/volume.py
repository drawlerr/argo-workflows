...
class Volume(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "awsElasticBlockStore": AWSElasticBlockStoreVolumeSource.from_dict(obj.get("awsElasticBlockStore")) if obj.get("awsElasticBlockStore") is not None else None,
            "azureDisk": AzureDiskVolumeSource.from_dict(obj.get("azureDisk")) if obj.get("azureDisk") is not None else None,
            "azureFile": AzureFileVolumeSource.from_dict(obj.get("azureFile")) if obj.get("azureFile") is not None else None,
            "cephfs": CephFSVolumeSource.from_dict(obj.get("cephfs")) if obj.get("cephfs") is not None else None,
            "cinder": CinderVolumeSource.from_dict(obj.get("cinder")) if obj.get("cinder") is not None else None,
            "configMap": ConfigMapVolumeSource.from_dict(obj.get("configMap")) if obj.get("configMap") is not None else None,
            "csi": CSIVolumeSource.from_dict(obj.get("csi")) if obj.get("csi") is not None else None,
            "downwardAPI": DownwardAPIVolumeSource.from_dict(obj.get("downwardAPI")) if obj.get("downwardAPI") is not None else None,
            "emptyDir": EmptyDirVolumeSource.from_dict(obj.get("emptyDir")) if obj.get("emptyDir") is not None else None,
            "ephemeral": EphemeralVolumeSource.from_dict(obj.get("ephemeral")) if obj.get("ephemeral") is not None else None,
            "fc": FCVolumeSource.from_dict(obj.get("fc")) if obj.get("fc") is not None else None,
            "flexVolume": FlexVolumeSource.from_dict(obj.get("flexVolume")) if obj.get("flexVolume") is not None else None,
            "flocker": FlockerVolumeSource.from_dict(obj.get("flocker")) if obj.get("flocker") is not None else None,
            "gcePersistentDisk": GCEPersistentDiskVolumeSource.from_dict(obj.get("gcePersistentDisk")) if obj.get("gcePersistentDisk") is not None else None,
            "gitRepo": GitRepoVolumeSource.from_dict(obj.get("gitRepo")) if obj.get("gitRepo") is not None else None,
            "glusterfs": GlusterfsVolumeSource.from_dict(obj.get("glusterfs")) if obj.get("glusterfs") is not None else None,
            "hostPath": HostPathVolumeSource.from_dict(obj.get("hostPath")) if obj.get("hostPath") is not None else None,
            "iscsi": ISCSIVolumeSource.from_dict(obj.get("iscsi")) if obj.get("iscsi") is not None else None,
            "name": obj.get("name"),
            "nfs": NFSVolumeSource.from_dict(obj.get("nfs")) if obj.get("nfs") is not None else None,
            "persistentVolumeClaim": PersistentVolumeClaimVolumeSource.from_dict(obj.get("persistentVolumeClaim")) if obj.get("persistentVolumeClaim") is not None else None,
            "photonPersistentDisk": PhotonPersistentDiskVolumeSource.from_dict(obj.get("photonPersistentDisk")) if obj.get("photonPersistentDisk") is not None else None,
            "portworxVolume": PortworxVolumeSource.from_dict(obj.get("portworxVolume")) if obj.get("portworxVolume") is not None else None,
            "projected": ProjectedVolumeSource.from_dict(obj.get("projected")) if obj.get("projected") is not None else None,
            "quobyte": QuobyteVolumeSource.from_dict(obj.get("quobyte")) if obj.get("quobyte") is not None else None,
            "rbd": RBDVolumeSource.from_dict(obj.get("rbd")) if obj.get("rbd") is not None else None,
            "scaleIO": ScaleIOVolumeSource.from_dict(obj.get("scaleIO")) if obj.get("scaleIO") is not None else None,
            "secret": SecretVolumeSource.from_dict(obj.get("secret")) if obj.get("secret") is not None else None,
            "storageos": StorageOSVolumeSource.from_dict(obj.get("storageos")) if obj.get("storageos") is not None else None,
            "vsphereVolume": VsphereVirtualDiskVolumeSource.from_dict(obj.get("vsphereVolume")) if obj.get("vsphereVolume") is not None else None
        })
        return _obj
