...
class BitbucketAuth(BaseModel):
    ...
    BitbucketAuth
    """ # noqa: E501
    basic: Optional[BitbucketBasicAuth] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "basic": BitbucketBasicAuth.from_dict(obj.get("basic")) if obj.get("basic") is not None else None,
            "oauthToken": SecretKeySelector.from_dict(obj.get("oauthToken")) if obj.get("oauthToken") is not None else None
        })
        return _obj
