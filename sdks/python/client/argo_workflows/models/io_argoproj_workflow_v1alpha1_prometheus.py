...
class IoArgoprojWorkflowV1alpha1Prometheus(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "counter": IoArgoprojWorkflowV1alpha1Counter.from_dict(obj.get("counter")) if obj.get("counter") is not None else None,
            "gauge": IoArgoprojWorkflowV1alpha1Gauge.from_dict(obj.get("gauge")) if obj.get("gauge") is not None else None,
            "help": obj.get("help"),
            "histogram": IoArgoprojWorkflowV1alpha1Histogram.from_dict(obj.get("histogram")) if obj.get("histogram") is not None else None,
            "labels": [IoArgoprojWorkflowV1alpha1MetricLabel.from_dict(_item) for _item in obj.get("labels")] if obj.get("labels") is not None else None,
            "name": obj.get("name"),
            "when": obj.get("when")
        })
        return _obj
