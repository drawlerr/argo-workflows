...
class IoArgoprojEventsV1alpha1ResourceFilter(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "fields": [IoArgoprojEventsV1alpha1Selector.from_dict(_item) for _item in obj.get("fields")] if obj.get("fields") is not None else None,
            "labels": [IoArgoprojEventsV1alpha1Selector.from_dict(_item) for _item in obj.get("labels")] if obj.get("labels") is not None else None,
