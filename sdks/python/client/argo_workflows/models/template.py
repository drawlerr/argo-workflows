...
class Template(BaseModel):
    ...
    archive_location: Optional[ArtifactLocation] = Field(default=None, alias="archiveLocation")
    ...
    container_set: Optional[ContainerSetTemplate] = Field(default=None, alias="containerSet")
    ...
    init_containers: Optional[List[UserContainer]] = Field(default=None, description="InitContainers is a list of containers which run before the main container.", alias="initContainers")
    ...
    sidecars: Optional[List[UserContainer]] = Field(default=None, description="Sidecars is a list of containers which run alongside the main container Sidecars are automatically killed when the main container completes")
    steps: Optional[List[ParallelSteps]] = Field(default=None, description="Steps define a series of sequential/parallel workflow steps")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "archiveLocation": ArtifactLocation.from_dict(obj.get("archiveLocation")) if obj.get("archiveLocation") is not None else None,
            ...
            "containerSet": ContainerSetTemplate.from_dict(obj.get("containerSet")) if obj.get("containerSet") is not None else None,
            "daemon": obj.get("daemon"),
            "dag": DAGTemplate.from_dict(obj.get("dag")) if obj.get("dag") is not None else None,
            ...
            "initContainers": [UserContainer.from_dict(_item) for _item in obj.get("initContainers")] if obj.get("initContainers") is not None else None,
            "inputs": Inputs.from_dict(obj.get("inputs")) if obj.get("inputs") is not None else None,
            "memoize": Memoize.from_dict(obj.get("memoize")) if obj.get("memoize") is not None else None,
            ...
            "resource": ResourceTemplate.from_dict(obj.get("resource")) if obj.get("resource") is not None else None,
            ...
            "script": ScriptTemplate.from_dict(obj.get("script")) if obj.get("script") is not None else None,
            ...
            "sidecars": [UserContainer.from_dict(_item) for _item in obj.get("sidecars")] if obj.get("sidecars") is not None else None,
            "steps": [ParallelSteps.from_dict(_item) for _item in obj.get("steps")] if obj.get("steps") is not None else None,
            "suspend": SuspendTemplate.from_dict(obj.get("suspend")) if obj.get("suspend") is not None else None,
...
Template.model_rebuild(raise_errors=False)
