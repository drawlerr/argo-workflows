...
class IoArgoprojWorkflowV1alpha1DAGTask(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "continueOn": IoArgoprojWorkflowV1alpha1ContinueOn.from_dict(obj.get("continueOn")) if obj.get("continueOn") is not None else None,
            ...
            "inline": IoArgoprojWorkflowV1alpha1Template.from_dict(obj.get("inline")) if obj.get("inline") is not None else None,
            "name": obj.get("name"),
            "onExit": obj.get("onExit"),
            "template": obj.get("template"),
            "templateRef": IoArgoprojWorkflowV1alpha1TemplateRef.from_dict(obj.get("templateRef")) if obj.get("templateRef") is not None else None,
            "when": obj.get("when"),
            "withItems": obj.get("withItems"),
            "withParam": obj.get("withParam"),
            "withSequence": IoArgoprojWorkflowV1alpha1Sequence.from_dict(obj.get("withSequence")) if obj.get("withSequence") is not None else None
        })
        return _obj
