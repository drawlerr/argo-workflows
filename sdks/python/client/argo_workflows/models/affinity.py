...
class Affinity(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "nodeAffinity": NodeAffinity.from_dict(obj.get("nodeAffinity")) if obj.get("nodeAffinity") is not None else None,
            "podAffinity": PodAffinity.from_dict(obj.get("podAffinity")) if obj.get("podAffinity") is not None else None,
            "podAntiAffinity": PodAntiAffinity.from_dict(obj.get("podAntiAffinity")) if obj.get("podAntiAffinity") is not None else None
        })
        return _obj
