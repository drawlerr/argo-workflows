...
class BitbucketEventSource(BaseModel):
    ...
    """ # noqa: E501
    auth: Optional[BitbucketAuth] = None
    ...
    repositories: Optional[List[BitbucketRepository]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "auth": BitbucketAuth.from_dict(obj.get("auth")) if obj.get("auth") is not None else None,
            ...
            "repositories": [BitbucketRepository.from_dict(_item) for _item in obj.get("repositories")] if obj.get("repositories") is not None else None,
