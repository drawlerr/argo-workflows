...
class IoArgoprojEventsV1alpha1HDFSEventSource(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "krbCCacheSecret": SecretKeySelector.from_dict(obj.get("krbCCacheSecret")) if obj.get("krbCCacheSecret") is not None else None,
            "krbConfigConfigMap": ConfigMapKeySelector.from_dict(obj.get("krbConfigConfigMap")) if obj.get("krbConfigConfigMap") is not None else None,
            "krbKeytabSecret": SecretKeySelector.from_dict(obj.get("krbKeytabSecret")) if obj.get("krbKeytabSecret") is not None else None,
            "krbRealm": obj.get("krbRealm"),
            "krbServicePrincipalName": obj.get("krbServicePrincipalName"),
            "krbUsername": obj.get("krbUsername"),
            "metadata": obj.get("metadata"),
            "type": obj.get("type"),
            "watchPathConfig": IoArgoprojEventsV1alpha1WatchPathConfig.from_dict(obj.get("watchPathConfig")) if obj.get("watchPathConfig") is not None else None
        })
        return _obj
