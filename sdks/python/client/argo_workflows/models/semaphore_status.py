...
class SemaphoreStatus(BaseModel):
    ...
    SemaphoreStatus
    """ # noqa: E501
    holding: Optional[List[SemaphoreHolding]] = Field(default=None, description="Holding stores the list of resource acquired synchronization lock for workflows.")
    waiting: Optional[List[SemaphoreHolding]] = Field(default=None, description="Waiting indicates the list of current synchronization lock holders.")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "holding": [SemaphoreHolding.from_dict(_item) for _item in obj.get("holding")] if obj.get("holding") is not None else None,
            "waiting": [SemaphoreHolding.from_dict(_item) for _item in obj.get("waiting")] if obj.get("waiting") is not None else None
        })
        return _obj
