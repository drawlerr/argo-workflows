...
class IoArgoprojWorkflowV1alpha1NodeStatus(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "memoizationStatus": IoArgoprojWorkflowV1alpha1MemoizationStatus.from_dict(obj.get("memoizationStatus")) if obj.get("memoizationStatus") is not None else None,
            "message": obj.get("message"),
            "name": obj.get("name"),
            "nodeFlag": IoArgoprojWorkflowV1alpha1NodeFlag.from_dict(obj.get("nodeFlag")) if obj.get("nodeFlag") is not None else None,
            ...
            "synchronizationStatus": IoArgoprojWorkflowV1alpha1NodeSynchronizationStatus.from_dict(obj.get("synchronizationStatus")) if obj.get("synchronizationStatus") is not None else None,
