...
class ArtifactGCSpec(BaseModel):
    ...
    """ # noqa: E501
    artifacts_by_node: Optional[Dict[str, ArtifactNodeSpec]] = Field(default=None, description="ArtifactsByNode maps Node name to information pertaining to Artifacts on that Node", alias="artifactsByNode")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "artifactsByNode": dict(
                (_k, ArtifactNodeSpec.from_dict(_v))
                for _k, _v in obj.get("artifactsByNode").items()
            )
