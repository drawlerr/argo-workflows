...
class IoArgoprojWorkflowV1alpha1RetryStrategy(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "affinity": IoArgoprojWorkflowV1alpha1RetryAffinity.from_dict(obj.get("affinity")) if obj.get("affinity") is not None else None,
            "backoff": IoArgoprojWorkflowV1alpha1Backoff.from_dict(obj.get("backoff")) if obj.get("backoff") is not None else None,
