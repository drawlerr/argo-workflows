...
class EventsourceCreateEventSourceRequest(BaseModel):
    ...
    """ # noqa: E501
    event_source: Optional[EventSource] = Field(default=None, alias="eventSource")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "eventSource": EventSource.from_dict(obj.get("eventSource")) if obj.get("eventSource") is not None else None,
