...
class SensorSpec(BaseModel):
    ...
    SensorSpec
    """ # noqa: E501
    dependencies: Optional[List[EventDependency]] = Field(default=None, description="Dependencies is a list of the events that this sensor is dependent on.")
    ...
    triggers: Optional[List[Trigger]] = Field(default=None, description="Triggers is a list of the things that this sensor evokes. These are the outputs from this sensor.")
    __properties: ClassVar[List[str]] = ["dependencies", "errorOnFailedRound", "eventBusName", "replicas", "template", "triggers"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "dependencies": [EventDependency.from_dict(_item) for _item in obj.get("dependencies")] if obj.get("dependencies") is not None else None,
