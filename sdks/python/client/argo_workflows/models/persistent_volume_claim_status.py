...
class PersistentVolumeClaimStatus(BaseModel):
    ...
    def phase_validate_enum(cls, value):
        ...
        if value not in ('Bound', 'Lost', 'Pending'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "conditions": [PersistentVolumeClaimCondition.from_dict(_item) for _item in obj.get("conditions")] if obj.get("conditions") is not None else None,
            "phase": obj.get("phase"),
