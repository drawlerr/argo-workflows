...
class IoArgoprojEventsV1alpha1Backoff(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "duration": IoArgoprojEventsV1alpha1Int64OrString.from_dict(obj.get("duration")) if obj.get("duration") is not None else None,
            "factor": IoArgoprojEventsV1alpha1Amount.from_dict(obj.get("factor")) if obj.get("factor") is not None else None,
            "jitter": IoArgoprojEventsV1alpha1Amount.from_dict(obj.get("jitter")) if obj.get("jitter") is not None else None,
            "steps": obj.get("steps")
        })
        return _obj
