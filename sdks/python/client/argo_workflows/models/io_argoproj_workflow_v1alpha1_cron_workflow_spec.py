...
class IoArgoprojWorkflowV1alpha1CronWorkflowSpec(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "stopStrategy": IoArgoprojWorkflowV1alpha1StopStrategy.from_dict(obj.get("stopStrategy")) if obj.get("stopStrategy") is not None else None,
            ...
            "workflowSpec": IoArgoprojWorkflowV1alpha1WorkflowSpec.from_dict(obj.get("workflowSpec")) if obj.get("workflowSpec") is not None else None
        })
        return _obj
