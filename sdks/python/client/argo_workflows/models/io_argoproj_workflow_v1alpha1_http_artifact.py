...
class IoArgoprojWorkflowV1alpha1HTTPArtifact(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "auth": IoArgoprojWorkflowV1alpha1HTTPAuth.from_dict(obj.get("auth")) if obj.get("auth") is not None else None,
            "headers": [IoArgoprojWorkflowV1alpha1Header.from_dict(_item) for _item in obj.get("headers")] if obj.get("headers") is not None else None,
            "url": obj.get("url")
        })
        return _obj
