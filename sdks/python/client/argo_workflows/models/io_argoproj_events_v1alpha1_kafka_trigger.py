...
class IoArgoprojEventsV1alpha1KafkaTrigger(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "payload": [IoArgoprojEventsV1alpha1TriggerParameter.from_dict(_item) for _item in obj.get("payload")] if obj.get("payload") is not None else None,
            "requiredAcks": obj.get("requiredAcks"),
            "sasl": IoArgoprojEventsV1alpha1SASLConfig.from_dict(obj.get("sasl")) if obj.get("sasl") is not None else None,
