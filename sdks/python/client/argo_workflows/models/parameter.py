...
class Parameter(BaseModel):
    ...
    global_name: Optional[StrictStr] = Field(default=None, description="GlobalName exports an output parameter to the global scope, making it available as '{{outputs.parameters.XXXX}} and in workflow.status.outputs.parameters", alias="globalName")
    ...
    value_from: Optional[ValueFrom] = Field(default=None, alias="valueFrom")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "value": obj.get("value"),
            "valueFrom": ValueFrom.from_dict(obj.get("valueFrom")) if obj.get("valueFrom") is not None else None
        })
        return _obj
