...
class IoArgoprojWorkflowV1alpha1S3EncryptionOptions(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "serverSideCustomerKeySecret": SecretKeySelector.from_dict(obj.get("serverSideCustomerKeySecret")) if obj.get("serverSideCustomerKeySecret") is not None else None
        })
        return _obj
