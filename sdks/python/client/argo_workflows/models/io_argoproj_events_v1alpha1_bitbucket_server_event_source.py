...
class IoArgoprojEventsV1alpha1BitbucketServerEventSource(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "repositories": [IoArgoprojEventsV1alpha1BitbucketServerRepository.from_dict(_item) for _item in obj.get("repositories")] if obj.get("repositories") is not None else None,
