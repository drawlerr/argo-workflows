...
class Lifecycle(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "postStart": LifecycleHandler.from_dict(obj.get("postStart")) if obj.get("postStart") is not None else None,
            "preStop": LifecycleHandler.from_dict(obj.get("preStop")) if obj.get("preStop") is not None else None
        })
        return _obj
