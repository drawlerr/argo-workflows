...
class SecureHeader(BaseModel):
    ...
    value_from: Optional[ValueFromSource] = Field(default=None, alias="valueFrom")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "valueFrom": ValueFromSource.from_dict(obj.get("valueFrom")) if obj.get("valueFrom") is not None else None
        })
        return _obj
