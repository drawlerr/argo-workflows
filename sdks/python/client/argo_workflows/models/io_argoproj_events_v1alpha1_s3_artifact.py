...
class IoArgoprojEventsV1alpha1S3Artifact(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessKey", "bucket", "endpoint", "events", "filter", "insecure", "metadata", "region", "secretKey"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "bucket": IoArgoprojEventsV1alpha1S3Bucket.from_dict(obj.get("bucket")) if obj.get("bucket") is not None else None,
            "endpoint": obj.get("endpoint"),
            "events": obj.get("events"),
            "filter": IoArgoprojEventsV1alpha1S3Filter.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
