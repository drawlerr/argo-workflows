...
class RetryStrategy(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "affinity": RetryAffinity.from_dict(obj.get("affinity")) if obj.get("affinity") is not None else None,
            "backoff": Backoff.from_dict(obj.get("backoff")) if obj.get("backoff") is not None else None,
