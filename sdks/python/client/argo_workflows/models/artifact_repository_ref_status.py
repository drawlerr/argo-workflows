...
class ArtifactRepositoryRefStatus(BaseModel):
    ...
    """ # noqa: E501
    artifact_repository: Optional[ArtifactRepository] = Field(default=None, alias="artifactRepository")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "artifactRepository": ArtifactRepository.from_dict(obj.get("artifactRepository")) if obj.get("artifactRepository") is not None else None,
