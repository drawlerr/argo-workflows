...
class Event(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "involvedObject": ObjectReference.from_dict(obj.get("involvedObject")) if obj.get("involvedObject") is not None else None,
            "kind": obj.get("kind"),
            ...
            "related": ObjectReference.from_dict(obj.get("related")) if obj.get("related") is not None else None,
            "reportingComponent": obj.get("reportingComponent"),
            "reportingInstance": obj.get("reportingInstance"),
            "series": EventSeries.from_dict(obj.get("series")) if obj.get("series") is not None else None,
