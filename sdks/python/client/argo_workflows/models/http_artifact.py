...
class HTTPArtifact(BaseModel):
    ...
    headers: Optional[List[Header]] = Field(default=None, description="Headers are an optional list of headers to send with HTTP requests for artifacts")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "auth": HTTPAuth.from_dict(obj.get("auth")) if obj.get("auth") is not None else None,
