...
class IoArgoprojEventsV1alpha1WebhookContext(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "authSecret": SecretKeySelector.from_dict(obj.get("authSecret")) if obj.get("authSecret") is not None else None,
            "endpoint": obj.get("endpoint"),
            "maxPayloadSize": obj.get("maxPayloadSize"),
            "metadata": obj.get("metadata"),
            "method": obj.get("method"),
            "port": obj.get("port"),
            "serverCertSecret": SecretKeySelector.from_dict(obj.get("serverCertSecret")) if obj.get("serverCertSecret") is not None else None,
            "serverKeySecret": SecretKeySelector.from_dict(obj.get("serverKeySecret")) if obj.get("serverKeySecret") is not None else None,
            "url": obj.get("url")
        })
        return _obj
