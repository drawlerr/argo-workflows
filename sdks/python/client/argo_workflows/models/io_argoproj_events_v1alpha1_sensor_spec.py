...
class IoArgoprojEventsV1alpha1SensorSpec(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "dependencies": [IoArgoprojEventsV1alpha1EventDependency.from_dict(_item) for _item in obj.get("dependencies")] if obj.get("dependencies") is not None else None,
            "errorOnFailedRound": obj.get("errorOnFailedRound"),
            "eventBusName": obj.get("eventBusName"),
            "replicas": obj.get("replicas"),
            "template": IoArgoprojEventsV1alpha1Template.from_dict(obj.get("template")) if obj.get("template") is not None else None,
            "triggers": [IoArgoprojEventsV1alpha1Trigger.from_dict(_item) for _item in obj.get("triggers")] if obj.get("triggers") is not None else None
        })
        return _obj
