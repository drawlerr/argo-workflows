...
class Arguments(BaseModel):
    ...
    """ # noqa: E501
    artifacts: Optional[List[Artifact]] = Field(default=None, description="Artifacts is the list of artifacts to pass to the template or workflow")
    parameters: Optional[List[Parameter]] = Field(default=None, description="Parameters is the list of parameters to pass to the template or workflow")
