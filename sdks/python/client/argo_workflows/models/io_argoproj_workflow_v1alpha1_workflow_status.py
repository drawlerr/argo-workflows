...
class IoArgoprojWorkflowV1alpha1WorkflowStatus(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "artifactGCStatus": IoArgoprojWorkflowV1alpha1ArtGCStatus.from_dict(obj.get("artifactGCStatus")) if obj.get("artifactGCStatus") is not None else None,
            "artifactRepositoryRef": IoArgoprojWorkflowV1alpha1ArtifactRepositoryRefStatus.from_dict(obj.get("artifactRepositoryRef")) if obj.get("artifactRepositoryRef") is not None else None,
            "compressedNodes": obj.get("compressedNodes"),
            "conditions": [IoArgoprojWorkflowV1alpha1Condition.from_dict(_item) for _item in obj.get("conditions")] if obj.get("conditions") is not None else None,
            ...
            "storedWorkflowTemplateSpec": IoArgoprojWorkflowV1alpha1WorkflowSpec.from_dict(obj.get("storedWorkflowTemplateSpec")) if obj.get("storedWorkflowTemplateSpec") is not None else None,
            "synchronization": IoArgoprojWorkflowV1alpha1SynchronizationStatus.from_dict(obj.get("synchronization")) if obj.get("synchronization") is not None else None,
