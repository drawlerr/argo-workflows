...
class HTTP(BaseModel):
    ...
    body_from: Optional[HTTPBodySource] = Field(default=None, alias="bodyFrom")
    headers: Optional[List[HTTPHeader]] = Field(default=None, description="Headers are an optional list of headers to send with HTTP requests")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "body": obj.get("body"),
            "bodyFrom": HTTPBodySource.from_dict(obj.get("bodyFrom")) if obj.get("bodyFrom") is not None else None,
            "headers": [HTTPHeader.from_dict(_item) for _item in obj.get("headers")] if obj.get("headers") is not None else None,
