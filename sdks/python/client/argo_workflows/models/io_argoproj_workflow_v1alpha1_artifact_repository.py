...
class IoArgoprojWorkflowV1alpha1ArtifactRepository(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "artifactory": IoArgoprojWorkflowV1alpha1ArtifactoryArtifactRepository.from_dict(obj.get("artifactory")) if obj.get("artifactory") is not None else None,
            "azure": IoArgoprojWorkflowV1alpha1AzureArtifactRepository.from_dict(obj.get("azure")) if obj.get("azure") is not None else None,
            "gcs": IoArgoprojWorkflowV1alpha1GCSArtifactRepository.from_dict(obj.get("gcs")) if obj.get("gcs") is not None else None,
            "hdfs": IoArgoprojWorkflowV1alpha1HDFSArtifactRepository.from_dict(obj.get("hdfs")) if obj.get("hdfs") is not None else None,
            "oss": IoArgoprojWorkflowV1alpha1OSSArtifactRepository.from_dict(obj.get("oss")) if obj.get("oss") is not None else None,
            "s3": IoArgoprojWorkflowV1alpha1S3ArtifactRepository.from_dict(obj.get("s3")) if obj.get("s3") is not None else None
        })
        return _obj
