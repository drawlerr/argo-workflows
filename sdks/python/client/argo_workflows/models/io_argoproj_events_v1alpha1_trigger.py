...
class IoArgoprojEventsV1alpha1Trigger(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "policy": IoArgoprojEventsV1alpha1TriggerPolicy.from_dict(obj.get("policy")) if obj.get("policy") is not None else None,
            "rateLimit": IoArgoprojEventsV1alpha1RateLimit.from_dict(obj.get("rateLimit")) if obj.get("rateLimit") is not None else None,
            "retryStrategy": IoArgoprojEventsV1alpha1Backoff.from_dict(obj.get("retryStrategy")) if obj.get("retryStrategy") is not None else None,
            "template": IoArgoprojEventsV1alpha1TriggerTemplate.from_dict(obj.get("template")) if obj.get("template") is not None else None
        })
        return _obj
