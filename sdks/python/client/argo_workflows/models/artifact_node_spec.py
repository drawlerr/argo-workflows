...
class ArtifactNodeSpec(BaseModel):
    ...
    artifacts: Optional[Dict[str, Artifact]] = Field(default=None, description="Artifacts maps artifact name to Artifact description")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "artifacts": dict(
                ...
                for _k, _v in obj.get("artifacts").items()
            )
