...
class Probe(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "exec": ExecAction.from_dict(obj.get("exec")) if obj.get("exec") is not None else None,
            "failureThreshold": obj.get("failureThreshold"),
            "grpc": GRPCAction.from_dict(obj.get("grpc")) if obj.get("grpc") is not None else None,
            "httpGet": HTTPGetAction.from_dict(obj.get("httpGet")) if obj.get("httpGet") is not None else None,
            ...
            "tcpSocket": TCPSocketAction.from_dict(obj.get("tcpSocket")) if obj.get("tcpSocket") is not None else None,
