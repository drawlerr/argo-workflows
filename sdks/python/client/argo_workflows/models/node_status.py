...
class NodeStatus(BaseModel):
    ...
    memoization_status: Optional[MemoizationStatus] = Field(default=None, alias="memoizationStatus")
    ...
    node_flag: Optional[NodeFlag] = Field(default=None, alias="nodeFlag")
    ...
    synchronization_status: Optional[NodeSynchronizationStatus] = Field(default=None, alias="synchronizationStatus")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "memoizationStatus": MemoizationStatus.from_dict(obj.get("memoizationStatus")) if obj.get("memoizationStatus") is not None else None,
            "message": obj.get("message"),
            "name": obj.get("name"),
            "nodeFlag": NodeFlag.from_dict(obj.get("nodeFlag")) if obj.get("nodeFlag") is not None else None,
            ...
            "synchronizationStatus": NodeSynchronizationStatus.from_dict(obj.get("synchronizationStatus")) if obj.get("synchronizationStatus") is not None else None,
