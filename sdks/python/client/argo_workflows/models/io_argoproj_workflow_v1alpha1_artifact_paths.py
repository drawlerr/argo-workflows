...
class IoArgoprojWorkflowV1alpha1ArtifactPaths(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "archive": IoArgoprojWorkflowV1alpha1ArchiveStrategy.from_dict(obj.get("archive")) if obj.get("archive") is not None else None,
            "archiveLogs": obj.get("archiveLogs"),
            "artifactGC": IoArgoprojWorkflowV1alpha1ArtifactGC.from_dict(obj.get("artifactGC")) if obj.get("artifactGC") is not None else None,
