...
class EnvFromSource(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "configMapRef": ConfigMapEnvSource.from_dict(obj.get("configMapRef")) if obj.get("configMapRef") is not None else None,
            "prefix": obj.get("prefix"),
            "secretRef": SecretEnvSource.from_dict(obj.get("secretRef")) if obj.get("secretRef") is not None else None
        })
        return _obj
