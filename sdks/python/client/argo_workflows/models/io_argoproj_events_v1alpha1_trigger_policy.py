...
class IoArgoprojEventsV1alpha1TriggerPolicy(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "k8s": IoArgoprojEventsV1alpha1K8SResourcePolicy.from_dict(obj.get("k8s")) if obj.get("k8s") is not None else None,
            "status": IoArgoprojEventsV1alpha1StatusPolicy.from_dict(obj.get("status")) if obj.get("status") is not None else None
        })
        return _obj
