...
class IoArgoprojEventsV1alpha1TriggerTemplate(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "argoWorkflow": IoArgoprojEventsV1alpha1ArgoWorkflowTrigger.from_dict(obj.get("argoWorkflow")) if obj.get("argoWorkflow") is not None else None,
            "awsLambda": IoArgoprojEventsV1alpha1AWSLambdaTrigger.from_dict(obj.get("awsLambda")) if obj.get("awsLambda") is not None else None,
            "azureEventHubs": IoArgoprojEventsV1alpha1AzureEventHubsTrigger.from_dict(obj.get("azureEventHubs")) if obj.get("azureEventHubs") is not None else None,
            "conditions": obj.get("conditions"),
            "conditionsReset": [IoArgoprojEventsV1alpha1ConditionsResetCriteria.from_dict(_item) for _item in obj.get("conditionsReset")] if obj.get("conditionsReset") is not None else None,
            "custom": IoArgoprojEventsV1alpha1CustomTrigger.from_dict(obj.get("custom")) if obj.get("custom") is not None else None,
            "http": IoArgoprojEventsV1alpha1HTTPTrigger.from_dict(obj.get("http")) if obj.get("http") is not None else None,
            "k8s": IoArgoprojEventsV1alpha1StandardK8STrigger.from_dict(obj.get("k8s")) if obj.get("k8s") is not None else None,
            "kafka": IoArgoprojEventsV1alpha1KafkaTrigger.from_dict(obj.get("kafka")) if obj.get("kafka") is not None else None,
            "log": IoArgoprojEventsV1alpha1LogTrigger.from_dict(obj.get("log")) if obj.get("log") is not None else None,
            "name": obj.get("name"),
            "nats": IoArgoprojEventsV1alpha1NATSTrigger.from_dict(obj.get("nats")) if obj.get("nats") is not None else None,
            "openWhisk": IoArgoprojEventsV1alpha1OpenWhiskTrigger.from_dict(obj.get("openWhisk")) if obj.get("openWhisk") is not None else None,
            "pulsar": IoArgoprojEventsV1alpha1PulsarTrigger.from_dict(obj.get("pulsar")) if obj.get("pulsar") is not None else None,
            "slack": IoArgoprojEventsV1alpha1SlackTrigger.from_dict(obj.get("slack")) if obj.get("slack") is not None else None
        })
        return _obj
