...
class IoArgoprojWorkflowV1alpha1Event(BaseModel):
    ...
    """ # noqa: E501
    selector: StrictStr = Field(description="Selector (https://github.com/antonmedv/expr) that we must must match the io.argoproj.workflow.v1alpha1. E.g. `payload.message == \"test\"`")
