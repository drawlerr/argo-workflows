...
class CronWorkflowServiceApi:
    ...
    def create_cron_workflow(
        ...
        :type namespace: str
        :param body: (required)
        :type body: CreateCronWorkflowRequest
    ...
    def lint_cron_workflow(
        ...
        :type namespace: str
        :param body: (required)
        :type body: LintCronWorkflowRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def resume_cron_workflow(
        ...
        namespace: StrictStr,
        name: StrictStr,
        body: CronWorkflowResumeRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type name: str
        :param body: (required)
        :type body: CronWorkflowResumeRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def suspend_cron_workflow(
        ...
        namespace: StrictStr,
        name: StrictStr,
        body: CronWorkflowSuspendRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type name: str
        :param body: (required)
        :type body: CronWorkflowSuspendRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def update_cron_workflow(
        ...
        body: UpdateCronWorkflowRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type name: str
        :param body: (required)
        :type body: UpdateCronWorkflowRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
