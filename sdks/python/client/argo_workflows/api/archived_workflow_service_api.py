...
class ArchivedWorkflowServiceApi:
    ...
    def resubmit_archived_workflow(
        self,
        uid: StrictStr,
        body: ResubmitArchivedWorkflowRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type uid: str
        :param body: (required)
        :type body: ResubmitArchivedWorkflowRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def retry_archived_workflow(
        self,
        uid: StrictStr,
        body: RetryArchivedWorkflowRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type uid: str
        :param body: (required)
        :type body: RetryArchivedWorkflowRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
