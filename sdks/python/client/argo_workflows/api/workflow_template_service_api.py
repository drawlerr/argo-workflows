...
class WorkflowTemplateServiceApi:
    ...
    def create_workflow_template(
        ...
        :type namespace: str
        :param body: (required)
        :type body: WorkflowTemplateCreateRequest
    ...
    def lint_workflow_template(
        self,
        namespace: StrictStr,
        body: WorkflowTemplateLintRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type namespace: str
        :param body: (required)
        :type body: WorkflowTemplateLintRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def list_workflow_templates_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WorkflowTemplateList]:
        """list_workflow_templates
    ...
    def update_workflow_template(
        ...
        :type name: str
        :param body: (required)
        :type body: WorkflowTemplateUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
