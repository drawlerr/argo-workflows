...
class EventServiceApi:
    ...
    def list_workflow_event_bindings_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WorkflowEventBindingList]:
        """list_workflow_event_bindings
    ...
    def receive_event(
        self,
        namespace: Annotated[StrictStr, Field(description="The namespace for the  This can be empty if the client has cluster scoped permissions. If empty, then the event is \"broadcast\" to workflow event binding in all namespaces.")],
