...
class WorkflowServiceApi:
    ...
    def create_workflow(
        ...
        :type namespace: str
        :param body: (required)
        :type body: WorkflowCreateRequest
    ...
    def resubmit_workflow(
        ...
        :type name: str
        :param body: (required)
        :type body: WorkflowResubmitRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def resume_workflow(
        ...
        :type name: str
        :param body: (required)
        :type body: WorkflowResumeRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def retry_workflow(
        ...
        :type name: str
        :param body: (required)
        :type body: WorkflowRetryRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def submit_workflow(
        ...
        :type namespace: str
        :param body: (required)
        :type body: WorkflowSubmitRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def suspend_workflow(
        ...
        :type name: str
        :param body: (required)
        :type body: WorkflowSuspendRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def terminate_workflow(
        ...
        :type name: str
        :param body: (required)
        :type body: WorkflowTerminateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def watch_workflows(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "StreamResultOfWorkflowWatchEvent",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def watch_workflows_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StreamResultOfWorkflowWatchEvent]:
        """watch_workflows
