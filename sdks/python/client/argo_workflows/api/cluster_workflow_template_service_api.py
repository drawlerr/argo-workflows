...
class ClusterWorkflowTemplateServiceApi:
    ...
    def create_cluster_workflow_template(
        self,
        body: ClusterWorkflowTemplateCreateRequest,
        ...
        :param body: (required)
        :type body: ClusterWorkflowTemplateCreateRequest
    ...
    def create_cluster_workflow_template_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ClusterWorkflowTemplate]:
        """create_cluster_workflow_template
    ...
    def lint_cluster_workflow_template(
        self,
        body: ClusterWorkflowTemplateLintRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param body: (required)
        :type body: ClusterWorkflowTemplateLintRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def list_cluster_workflow_templates(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ClusterWorkflowTemplateList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_cluster_workflow_templates_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ClusterWorkflowTemplateList]:
        """list_cluster_workflow_templates
    ...
    def update_cluster_workflow_template(
        ...
        body: ClusterWorkflowTemplateUpdateRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type name: str
        :param body: (required)
        :type body: ClusterWorkflowTemplateUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
